...
import 'package:flutter_app_cms/widget/Cardnews_List.dart';
import 'package:flutter_app_cms/widget/Cardnews_Header.dart';
              ...
              new Column(
                children: [
                  ...
                  ListTile(
                      ...
                      onTap: () {
                        Navigator.pushNamed(context, '/homemessenger');
                      }),
                  // ListTile(
                  //     title: new Text(
                  //       'Bản Đồ ',
    ...
    return Row(
      ...
      children: [
        ...
        GestureDetector(
          ...
          child: Text(
            (ServicesAPI.userModel.name == "") ? "ĐĂNG NHẬP" : "ĐĂNG XUẤT"
            // setState(() {
            //   if (ServicesAPI.userModel.name == null)
            //     return "ĐĂNG NHẬP";
            //   else
